...
export const PreviewProjectCard = ({ data }: any) => {
  ...
  return (
    <div className="px-2 py-2 border-2 border-slate-800 rounded-md bg-slate-900 flex gap-4 w-full flex justify-between">
      ...
      {auth._id !== data.creator && (
        <div className="ml-0 md:ml-4 bg-sky-400 rounded-full px-2">Partner</div>
      )}
